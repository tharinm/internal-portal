...
export function TopBar({ userEmail }: TopBarProps) {
  return (
    <header className="sticky top-0 z-20 flex h-14 items-center justify-between gap-2 border-b bg-background/95 px-4 backdrop-blur sm:px-6">
      <Link
        href="/"
        className="shrink-0 whitespace-nowrap rounded-md font-heading text-sm font-medium tracking-tight outline-none transition-colors hover:text-primary focus-visible:ring-3 focus-visible:ring-ring/50 sm:text-base"
      >
        Internal Portal
      </Link>
